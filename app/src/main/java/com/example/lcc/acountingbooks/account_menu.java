...
public class account_menu extends AppCompatActivity implements View.OnClickListener {

    static final String TB_NAME = "AccountNote";    //資料表名稱
    static final String[] FROM = new String[]{"money"};
    static final String CreditCardName = "CreditCard";    //信用卡項目資料檔名稱
    TextView mThisYearPay, mThisYearIncome, mThisYearTotalView,
             mThisMonthPay,mThisMonthIcome,mThisMonthTotalView;
    ...
    private void myFindView() {
        ...
        mThisMonthIcome = (TextView) findViewById(R.id.txtThisMonthIncome);
    ...
    @Override
    public void onClick(View view) { //按下母欄位可展開子欄位
        switch (view.getId()) {
    ...
    private void thisMonthIncome(){
        ...
        mThisMonthIcome.setText(""+mThisMonthTotalIncome);
        cursor.close();
    }
